# vgi-audio — dev and test targets.
#
# Usage:
...
#
# test-sql is self-contained: it points VGI_AUDIO_WORKER at the worker run as
...
WORKER_STDIO    ?= uv run --python 3.13 audio_worker.py
